...
//     @Override
//     public void init() {
//         this.staticCommittee = this.committeeElection.performCommitteeElection(
//             this.config.getStaticElectionCriteria()).get();
...
//             var config = BftSmartConsensus.this.config;
...
//         protected boolean verifyBody(BlockBody body)
//         {
//             return BftSmartConsensus.super.verifyBody(body);
//         }
...
//             super(
//                     BftSmartConsensus.this.config.getBlockmessConnectorHost(),
//                     BftSmartConsensus.this.config.getBlockmessConnectorPort());
//         }
