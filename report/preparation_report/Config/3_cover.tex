...
\nttitle(main,en){HyFlexChain: A Permissionless \\ Decentralized Ledger with Hybrid \\ and Flexible Consensus Plane}%
\nttitle(main,pt){Melhorar desempenho em Ledgers descentralizados\\com planos de consenso adaptativos}%

%         You may use "\\" to force line breaks
% \nttitle(sub,en){Improving Performance in Decentralized Ledgers\\with Adaptive Consensus Planes}%
...
%-------------------------------------------------------------------
\ntauthorname(m){Henrique José Penides Campos Ferreira}{Henrique Campos Ferreira}

%-------------------------------------------------------------------
% AUTHOR previous degree
% SYNTAX: \ntauthordegree{degree}
%-------------------------------------------------------------------
\ntauthordegree(en){BSc in Informatics Engineering}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){Henrique Domingos, Associate Professor, NOVA University - Nova School of Sciences and Engineering}
% Co-advisers(s)
